...
function envSentinel(options: EnvSentinelOptions | string = {}, projectPath: string = process.cwd()): void {
  let debug = false;
...
function getAllJSAndTSFiles(dir: string, log: (...args: any[]) => void): string[] {
...
function checkEnvVariable(variable: string, node: ts.Node, sourceFile: ts.SourceFile, log: (...args: any[]) => void, errors: string[]): void {
